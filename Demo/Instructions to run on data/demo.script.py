...
class PatchEmbedding(nn.Module):
    def __init__(self, w):
        super().__init__()
        self.conv1 = nn.Conv2d(1, 1, (50, 101), (1, 1))
        self.conv2 = nn.Conv2d(1, 1, (30, 101), (1, 1))
        self.conv3 = nn.Conv2d(1, 1, (1, 101), (1, 1))
        self.conv4 = nn.Conv2d(1, 1, (1, 100), (1, 1))
...
class TModel(nn.Module):
    def __init__(self,embed_size, w, param,num_layers):
        ...
        self.layers = nn.Sequential(
            *[
                AttentionBlock(
                    embed_size1=param[i]["embed_size1"],
                    embed_size2=param[i]["embed_size2"],
                    num_heads=param[i]["num_heads"]
                )
        ...
        self.out_r=nn.Sequential(nn.Conv1d(1,1,20,2),nn.Sigmoid(),nn.Conv1d(1,1,8,1),nn.Sigmoid())
